...
# WEATHER DISPLAY
# ======================================
st.header("🌦 Live Weather Information")
...
# PREDICTION SECTION
# ======================================
st.header("🔮 Waste Prediction & Order Optimization")
...
st.success("🎉 AI-powered system helps reduce waste and increase profitability.")